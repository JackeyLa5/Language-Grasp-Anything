...
# python generate_graspness.py --dataset_root /home/yzhang/graspness_data/graspnet --camera_type realsense
    ...
    for scene_id in range(90,100):
        ...
        for ann_id in range(256):
            ...
            for i in obj_list:
                ...
                grasp_labels[i] = (file['points'].astype(float), file['offsets'].astype(float),
                                   file['scores'].astype(float))
