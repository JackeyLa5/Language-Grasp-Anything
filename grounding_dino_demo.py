...
def parse_opt():
    ...
    parser.add_argument("--input_image", type=str, default="./pics/rgb1.jpg", help="path to image file")
    parser.add_argument("--text_prompt", type=str, help="text prompt")
    parser.add_argument("--output_dir", "-o", type=str, default="pics", help="output directory")
